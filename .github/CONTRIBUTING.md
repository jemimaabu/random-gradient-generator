# Contributing
The purpose of this project is to be an intro into open source for any beginners so you can go through the project site here [Random Gradient Generator](https://jemimaabu.github.io/random-gradient-generator/) and then choose something to work on.
...
## Getting Started
**Step 1**:  Create an issue for the task you want to work on (go through the [Issues](https://github.com/jemimaabu/random-gradient-generator/issues) page first to make sure it doesn't already exist) or select an already existing issue to work on.
